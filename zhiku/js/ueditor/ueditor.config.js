...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        //, serverUrl: URL + "php/imageUp.php"
        ,imageUrl:URL+"php/imageUp.php"             //图片上传提交地址
        ,imagePath: "http://haoqiao.wisetravel.cn/"                                //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
        //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        //,compressSide:0                            //等比压缩的基准，确定maxImageSideLength参数的参照对象。0为按照最长边，1为按照宽度，2为按照高度
        ,maxImageSideLength:1000                   //上传图片最大允许的边长，超过会自动等比缩放,不缩放就设置一个比较大的值，更多设置在image.html中
        ,savePath: [ '/www/hotel/upload/images' ]      //图片保存在服务器端的目录， 默认为空， 此时在上传图片时会向服务器请求保存图片的目录列表，
                                                            // 如果用户不希望发送请求， 则可以在这里设置与服务器端能够对应上的目录名称列表
                                                            //比如： savePath: [ 'upload1', 'upload2' ]

        //涂鸦图片配置区
        ,scrawlUrl:URL+"php/scrawlUp.php"           //涂鸦上传地址
        ,scrawlPath:URL+"http://haoqiao.wisetravel.cn/"                            //图片修正地址，同imagePath

        //附件上传配置区
        ,fileUrl:URL+"php/fileUp.php"               //附件上传提交地址
        ,filePath:URL + "http://haoqiao.wisetravel.cn/"                   //附件修正地址，同imagePath
        ...
        ,imageManagerPath: "http://haoqiao.wisetravel.cn/"                                    //图片修正地址，同imagePath
        ...
        , toolbars:[
            ['fullscreen', 'source', '|', 'undo', 'redo', '|',
                ...
                'print', 'preview', 'searchreplace', 'help', 'drafts', "spacing"]
        ]
...
//           ]
        ...
        //清除格式时可以删除的标签和属性
        //removeForamtTags标签
        ,removeFormatTags:'b,big,code,del,dfn,em,font,i,ins,kbd,q,samp,small,span,strike,strong,sub,sup,tt,u,var,li,ul'
